...
class AlSaj extends StatefulWidget {
  @override
  _AlSajState createState() => _AlSajState();
}

class _AlSajState extends State<AlSaj> {
                            ...
                            child: Column(
                              children: [
                                FlatButton(
                                  ...
                                  child: Image.asset(
                                      'assets/Home/BurgerKing/bk2.jpg'),
                                ),
                              ],
                            ),
                          ),
                            ...
                            child: Column(
                              children: [
                                FlatButton(
                                  ...
                                  child: Image.asset(
                                      'assets/Home/BurgerKing/bk4.jpg'),
                                ),
                              ],
                            ),
                          ),
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (BuildContext context) => BuyTwoFree()));
                },
                child: Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              !state
                                  ...
                                  : _ImageBottomSheet4(context);
                            },
                            child: !state
                                ? Image.asset('assets/Home/BurgerKing/bk6.jpg')
                    ...
                    children: [
                      Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              !state
                                  ? _ImageBottomSheet1(context)
                                  : _ImageBottomSheet5(context);
                            },
                            child: !state
                                ? Image.asset('assets/Home/BurgerKing/bk8.jpg')
                                : Image.asset(
                                    'assets/Home/BurgerKing/bk11.jpg'),
                          )),
                      !isAdding1
                          ? FlatButton(
                              color: Colors.white,
                    ...
                    children: [
                      Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              !state
                                  ? _ImageBottomSheet2(context)
                                  : _ImageBottomSheet6(context);
                            },
                            child: !state
                                ? Image.asset('assets/Home/BurgerKing/bk9.jpg')
                                : Image.asset(
                                    'assets/Home/BurgerKing/bk12.jpg'),
                          )),
                      !isAdding2
                          ? FlatButton(
                              color: Colors.white,
                    ...
                    children: [
                      Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              !state
                                  ? _ImageBottomSheet3(context)
                                  : _ImageBottomSheet4(context);
                            },
                            child: !state
                                ? Image.asset('assets/Home/BurgerKing/bk10.jpg')
                                : Image.asset('assets/Home/BurgerKing/bk7.jpg'),
                          )),
                      !isAdding3
                          ? FlatButton(
