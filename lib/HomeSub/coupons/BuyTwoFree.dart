...
class BuyTwoFree extends StatefulWidget {
  @override
  _BuyTwoFreeState createState() => _BuyTwoFreeState();
}

class _BuyTwoFreeState extends State<BuyTwoFree> {
  final List<Map> sort = [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                    image: AssetImage('assets/Home/coupon/cu3.jpg'),
                    fit: BoxFit.fill),
              ),
            ),
            Row(
              children: [
                ...
                GestureDetector(
                                  ...
                                  actions: [
                                    Center(
                                      child: Text(
                                        'Clear All',
                                        style:
                                            TextStyle(color: Color(0xff550d0e)),
                                      ),
                                    ),
                                    SizedBox(
                                        width:
                  ...
                  child: Container(
                    padding: EdgeInsets.fromLTRB(10, 15, 0, 10),
                    child: Row(
                      children: [Icon(Icons.sort), Text('  Sort / Filter')],
                    ),
                  ),
                ),
              ],
