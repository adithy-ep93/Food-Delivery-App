...
import 'package:FoodDelivery/HomeSub/BuyAnythingPages/SubMapSelectAStore.dart';
...
class MapSelectAStore extends StatefulWidget {
  MapSelectAStore() : super();
  final String title = "Maps";

  @override
  _MapSelectAStoreState createState() => _MapSelectAStoreState();
}

class _MapSelectAStoreState extends State<MapSelectAStore> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  //         labelText:
                  //             "COMPLETE THIS ADDRESS (HOUSE NO., LANW NO, ETC.)",
                  //         hintStyle:
                  ...
                  Container(
                    ...
                    context,
                    MaterialPageRoute(
                    builder: (BuildContext context) =>SubMapSelectAStore()));
