...
class BuyAnything extends StatefulWidget {
  @override
  _BuyAnythingState createState() => _BuyAnythingState();
}

class _BuyAnythingState extends State<BuyAnything> {
  @override
                                  ...
                                  children: <TextSpan>[
                                    TextSpan(
                                      text:
                                          ...
                                          'prohibited by low. Yummy reserves the right to share\n'
                  ...
                  child: GestureDetector(
                    onTap: (){
                      Navigator.push(
                              context,
                              MaterialPageRoute(
                              builder: (BuildContext context) => SelectAStore()));
                    },
                                      child: Image.asset(
