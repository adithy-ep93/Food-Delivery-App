import 'package:FoodDelivery/HomeSub/Meat/MeatSub1.dart';
import 'package:flutter/material.dart';
import 'package:number_inc_dec/number_inc_dec.dart';
class AziaSubChicken extends StatefulWidget {
  @override
  _AziaSubChickenState createState() => _AziaSubChickenState();
}

class _AziaSubChickenState extends State<AziaSubChicken> {
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            Text('Azia Halal Chicken And Meat Shop',
            style: TextStyle(
              color: Colors.black,
              fontSize:15
            ),)
