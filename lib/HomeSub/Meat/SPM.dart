import 'package:FoodDelivery/HomeSub/Meat/SPMSub.dart';
import 'package:flutter/material.dart';
import 'package:dotted_line/dotted_line.dart';

class SPM extends StatefulWidget {
  @override
  _SPMState createState() => _SPMState();
}
      ...
      Column(children: [
        ...
        Container(
          ...
          child: Column(children: [
            ...
            RichText(text: TextSpan(text: 'SPM Meat Stall and Meat Shop',style: 
            TextStyle(
              color: Colors.black,
              fontSize: 20,
              fontWeight: FontWeight.bold
            ...
            Row(
              children: [
                ...
                RichText(text: TextSpan(text: 'SPM meat stall  and Meat Shop Kazhakuttam',style: 
                TextStyle(
                  color: Colors.black,
                  fontSize: 16,
