...
class AllStars extends StatefulWidget {
  @override
  _AllStarsState createState() => _AllStarsState();
}

class _AllStarsState extends State<AllStars> {
         ...
         height: MediaQuery.of(context).size.height*.2,
          decoration: BoxDecoration(
            image: DecorationImage(
              image:AssetImage('assets/Home/h10.jpg') ,
              fit: BoxFit.fill
              ),
        ...
        Container(
          ...
          child: Column(children: [
            ...
            RichText(text:TextSpan(
              text: 'Celebrate the very best of food delivery restaurants ! Order in from the heighest rated restaurants near you.',
