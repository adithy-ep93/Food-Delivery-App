            ...
            children: [
              ...
              Center(
                child: FloatingActionButton.extended(
                  label: Text(
                    'Bussiness owner? Try Genie for bussiness',
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (BuildContext context) => PickupDrop()));
                    },
                    child: Container(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                'Introducing Genie Link - a faster and easier',
                                style: TextStyle(
                                  fontSize: 14,
                                ),
                              )
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                'way to manage customer order deliveries',
                                style: TextStyle(
                                  fontSize: 14,
                                ),
                              )
